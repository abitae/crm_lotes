...
type PageProps = { projects: Project[]; flash?: { success?: string; error?: string } };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4 md:p-6">
                {(flash.success || flash.error) && (
                    <Alert variant={flash.error ? 'destructive' : 'default'} className={flash.success ? 'border-emerald-200 bg-emerald-50 text-emerald-800' : ''}>
