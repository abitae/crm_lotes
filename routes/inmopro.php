...
Route::middleware(['auth', 'verified'])->prefix('inmopro')->name('inmopro.')->group(function (): void {
    ...
    Route::post('advisors/{advisor}/memberships', [AdvisorController::class, 'storeMembership'])->name('advisors.memberships.store');
    Route::post('advisors/{advisor}/reset-pin', [AdvisorController::class, 'resetPin'])->name('advisors.reset-pin');
    ...
    Route::post('accounts-receivable/membership-payments', [AccountsReceivableController::class, 'storeMembershipPayment'])->name('accounts-receivable.membership-payments.store');
